...
i32 tree_solve_relative(storage_tree_t* here, char* out, u64 out_size,
    storage_tree_t* root)
{
    if (out_size < 2)
        return -1;
...
i32 tree_detach_file(storage_tree_t* from, const char* restrict relative,
...
i32 tree_fill(storage_tree_t* mirror, storage_tree_t* fill, storage_fio_t* fmem,
