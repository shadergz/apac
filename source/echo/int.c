...
i32
echo_format (apac_ctx_t *apac_ctx, char *msg, u64 msgs, echo_level_e level,
...
i32
echo_do (apac_ctx_t *apac_ctx, echo_level_e msg_level, i32 code_line,
...
i32
echo_deinit (apac_ctx_t *apac_ctx)
{
