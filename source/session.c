...
i32
session_makestorage (apac_ctx_t *apac_ctx)
{
  char *exec_dir = NULL;
...
i32
session_backend (apac_ctx_t *apac_ctx)
{
...
i32
session_lock (apac_ctx_t *apac_ctx)
{
...
i32
session_unlock (apac_ctx_t *apac_ctx)
{
...
i32
session_loadconfig (apac_ctx_t *apac_ctx)
{
...
i32
session_init (i32 argc, char *argv[], apac_ctx_t *apac_ctx)
{
...
i32
session_deinit (apac_ctx_t *apac_ctx)
{
